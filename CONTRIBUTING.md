...
> [!IMPORTANT]
> If any changes are made to `config/files.mlc` (or any MLC files), run:

```bash
vendor/bin/mlc-check config/files.mlc
```
...
```bash
git clone https://github.com/MonkeysCloud/MonkeysLegion-Files.git
cd MonkeysLegion-Files
```
